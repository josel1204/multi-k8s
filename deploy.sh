...
kubectl set image deployments/client-deployment server=josel1204/multi-client:$SHA
kubectl set image deployments/worker-deployment server=josel1204/multi-worker:$SHA